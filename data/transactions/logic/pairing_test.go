...
func TestFieldCosts(t *testing.T) { //nolint:paralleltest // manipulates opcode table
	...
	withOpcode(t, LogicVersion, xxx, func(opcode byte) {
		testApp(t, "int 32; bzero; xxx BN254g1; global OpcodeBudget; int 687; ==", defaultEvalParams())
		testApp(t, "int 32; bzero; xxx BN254g2; global OpcodeBudget; int 677; ==", defaultEvalParams())
		testApp(t, "int 32; bzero; xxx BLS12_381g1; global OpcodeBudget; int 667; ==", defaultEvalParams())
		testApp(t, "int 32; bzero; xxx BLS12_381g2; global OpcodeBudget; int 664; ==", defaultEvalParams())
	})
}
...
func TestLinearFieldCost(t *testing.T) { //nolint:paralleltest // manipulates opcode table
	...
	withOpcode(t, LogicVersion, xxx, func(opcode byte) {
		...
		testApp(t, "int 0; bzero; xxx BN254g1; global OpcodeBudget; int 696; ==", defaultEvalParams())
		testApp(t, "int 1; bzero; xxx BN254g1; global OpcodeBudget; int 694; ==", defaultEvalParams())
		testApp(t, "int 2; bzero; xxx BN254g1; global OpcodeBudget; int 694; ==", defaultEvalParams())
		testApp(t, "int 3; bzero; xxx BN254g1; global OpcodeBudget; int 692; ==", defaultEvalParams())
		testApp(t, "int 4; bzero; xxx BN254g1; global OpcodeBudget; int 692; ==", defaultEvalParams())

		// starts at 5, goes up by two for each 10 bytes
		testApp(t, "int 0; bzero; xxx BN254g2; global OpcodeBudget; int 692; ==", defaultEvalParams())
		testApp(t, "int 1; bzero; xxx BN254g2; global OpcodeBudget; int 690; ==", defaultEvalParams())
		testApp(t, "int 2; bzero; xxx BN254g2; global OpcodeBudget; int 690; ==", defaultEvalParams())
		testApp(t, "int 9; bzero; xxx BN254g2; global OpcodeBudget; int 690; ==", defaultEvalParams())
		testApp(t, "int 10; bzero; xxx BN254g2; global OpcodeBudget; int 690; ==", defaultEvalParams())
		testApp(t, "int 11; bzero; xxx BN254g2; global OpcodeBudget; int 688; ==", defaultEvalParams())
	})
}
